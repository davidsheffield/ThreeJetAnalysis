                      ...
                      iConfig.getParameter<InputTag>("photon_collection")))
{
    ...
    TFileDirectory Muon = fs->mkdir("Muon");
    TFileDirectory Electron = fs->mkdir("Electron");
    TFileDirectory Photon = fs->mkdir("Photon");
    ...
    h_muon_num = TH1DInitializer(&Muon, "h_muon_num", "PF Scouting Muons",
                                 10, -0.5, 9.5, "number of muons", "events");
    ...
    h_muon_charge = TH1DInitializer(&Muon, "h_muon_charge", "PF Scouting Muons",
                                    3, -1.5, 1.5, "charge", "muons");
    ...
    h_muon_nValidMuonHits = TH1DInitializer(&Muon, "h_muon_nValidMuonHits",
                                            "PF Scouting Muons", 60, -0.5, 59.5,
                                            "valid muon hits", "muons");
    h_muon_nValidPixelHits = TH1DInitializer(&Muon, "h_muon_nValidPixelHits",
                                             "PF Scouting Muons", 10, -0.5, 9.5,
                                             "valid pixel hits", "muons");
    h_muon_nMatchedStations = TH1DInitializer(&Muon, "h_muon_nMatchedStations",
                                              "PF Scouting Muons",
                                              50, -0.5, 49.5,
    ...
    h_muon_isTrackerMuon = TH1DInitializer(&Muon, "h_muon_isTrackerMuon",
                                           "PF Scouting Muons", 2, -0.5, 1.5,
                                           "isTrackermuon", "muons");
    h_dimuon_mass_twoMuons = TH1DInitializer(&Muon, "h_dimuon_mass_twoMuons",
                                             "PF Scouting Muons",
                                             1000, 0.0, 1000.0,
                                             "M_{#mu^{+}#mu^{-}} [GeV]",
                                             "events");
    h_dimuon_mass_allMuons = TH1DInitializer(&Muon, "h_dimuon_mass_allMuons",
                                             "PF Scouting Muons",
                                             1000, 0.3, 2000.0,
                                             "M_{#mu^{+}#mu^{-}} [GeV]",
                                             "events / 1 GeV", true);
    h_dimuon_mass_allButTwoMuons = TH1DInitializer(
        ...
        1000, 0.3, 2000.0, "M_{#mu^{+}#mu^{-}} [GeV]", "events / 1 GeV", true);
    ...
    h_electron_phi = TH1DInitializer(&Electron, "h_electron_phi",
                                     "PF Scouting Muons", 100, -3.1416, 3.1416,
                                     "#phi", "electrons");
    ...
    h_photon_num = TH1DInitializer(&Photon, "h_photon_num", "PF Scouting Muons",
                                   10, -0.5, 9.5, "number of photons",
                                   "events");
    h_photon_pt = TH1DInitializer(&Photon, "h_photon_pt", "PF Scouting Muons",
                                  500, 0.0, 500.0, "p_{T} [GeV]", "photons");
    h_photon_eta = TH1DInitializer(&Photon, "h_photon_eta", "PF Scouting Muons",
                                   100, -2.5, 2.5, "#eta", "photons");
    h_photon_phi = TH1DInitializer(&Photon, "h_photon_phi", "PF Scouting Muons",
                                   100, -3.1416, 3.1416, "#phi", "photons");
    h_photon_mass = TH1DInitializer(&Photon, "h_photon_mass",
                                    "PF Scouting Muons", 200, -1.0, 1.0,
                                    "mass [MeV]", "photons");
    h_photon_sigmaIetaIeta = TH1DInitializer(&Photon, "h_photon_sigmaIetaIeta",
                                             "PF Scouting Muons",
                                             200, -1.0, 1.0, "sigmaIetaIeta",
                                             "photons");
